...
//        print_r($list);
		...
		$this->assertTrue(key_exists('Rizwan Ahmed', $list));
		$this->assertEquals(0, count($list['Rizwan Ahmed']));
        // To be tested:
    ...
    public function testRemoveUnreferencedActors()
    {
        ...
        $list = $disney->getActorStatistics();
		$this->assertEquals(89, count($list));
		$this->assertFalse(key_exists('Rizwan Ahmed', $list));
		$this->assertFalse(key_exists('Erik Thomas von Detten', $list));
//        print_r($list);
        // To be tested:
    ...
    public function testAddRole()
    {
        ...
        $disney->addRole($subsidiaryId, $movieName, $movieYear, $roleName,
                               $roleActor);
        $list = $disney->getActorStatistics();
		$this->assertTrue(in_array('As Loki in Avengers: Infinity War (2018)', $list['Tom Hiddleston']));
//        print_r($list);
        // To be tested:
